...
use \Elastest\ScopeInterface;

use \Elastest\Http\HttpRequestInterface;
use \Elastest\Http\HttpResponseInterface;

use \Elastest\Scope; // Could be books, authors or/and publishers ???
...
/**
 * @see BooksControllerInterface
 */
class BooksController implements BooksControllerInterface { // Could be standard ResourceControllerInterface
    /**
     * @var string
     */
    private $scope;
     ...
     * Constructor
     *
     * @param BooksInterface  $booksStorage  REQUIRED Instance of Elastest\Storage\BooksInterface to retrieve books information
     * @param array           $responseTypes OPTIONAL Array of Elastest\ResponseTypes\ResponseTypeInterface objects.  Valid array keys are "code" and "token"
     ...
     * @endcode
     */
    public function __construct(BooksInterface $booksStorage, array $responseTypes = array(), array $config = array(), ScopeInterface $scopeUtil = null)
    {
